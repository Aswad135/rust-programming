...
fn main() {
    ...
    if (choice > 6) | (choice < 1)
    {
        ...
        if choice == 1 {
            ...
            let tuple_demo: (i64, f32) = (first_num as i64, second_num as f32);
...
fn find_mean(val: Vec<i32>) -> f32 {
    ...
    (sum / val.len() as i32) as f32
}

fn find_remainder(data: (i64, f32)) -> f32 {
    (data.0 % data.1 as i64) as f32
}